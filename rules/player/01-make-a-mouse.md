...
See also: [Gear and prices](../reference/gear-and-prices.md) and [Names and bric-a-brac](../reference/names-and-bric-a-brac.md).
...
For each of these attributes, in order, roll **3d**.
...
If your mouse’s highest attribute is 9 or less, roll on the
Background table again and take either Item A or B. If
your highest is 7 or less, take both.
