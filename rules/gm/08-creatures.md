...
As a general rule of thumb, the more closely related two
creatures are, the more likely they are to understand
each other. Magical or highly intelligent creatures may
break these rules.

**-** Other **mice** : Can easily communicate.
**-** Other **rodents** : Can speak and communicate,
...
for creating new antagonists for your players.
When a creature lists critical damage in its stat block,
this occurs instead of the standard critical damage
effect.
...
wraps the him up in its web and starts to escape. Hopefully Burdock’s
...
```
**_Wants_** _to protect the secret hallowed places from those
that would do them harm_
...
Knows one spell
```
**_Wants_** _to further the Faerie Queen’s strange agenda_
...
```
```
Wants freedom from the pain that binds them to the
mortal realm
Ghostly powers
```
...
```
**_Wants_** _to collect rare knowledge and spells_
...
Attacks: d6 cleaver
```
**_Wants_** _easy wealth, to take from the weak_
...
Attacks: d8 bite
Critical damage: Swallow whole, d4 STR
